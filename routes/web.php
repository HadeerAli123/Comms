...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/commissions/export', [CommissionController::class, 'export'])
        ->middleware('permission:reports.export')->name('commissions.export');
    ...
    // Delivery code flows are separated for clarity and future extensibility
    ...
    // Only one resource route for marketing employees to avoid duplication
    ...
    Route::get('clients', [ClientController::class, 'index'])
        ->middleware('permission:reports.view')->name('clients.index');

    // Only Admins can access country management
