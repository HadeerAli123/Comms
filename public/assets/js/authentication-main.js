(function () {
    ...
    // تحديد baseUrl من <base> أو الجذر
    ...
    if (localStorage.zynixrtl) {
        ...
        document.querySelector("#style")?.setAttribute("href", baseUrl + "assets/libs/bootstrap/css/bootstrap.rtl.min.css");
        // rtlFn();
    }
    ...
    // دوال LTR و RTL مع baseUrl
    window.ltrFn = function () {
        let html = document.querySelector('html');
        if (!document.querySelector("#style").href.includes('bootstrap.min.css')) {
            document.querySelector("#style")?.setAttribute("href", baseUrl + "assets/libs/bootstrap/css/bootstrap.min.css");
        }
        html.setAttribute("dir", "ltr");
    }

    window.rtlFn = function () {
        let html = document.querySelector('html');
        html.setAttribute("dir", "rtl");
        document.querySelector("#style")?.setAttribute("href", baseUrl + "assets/libs/bootstrap/css/bootstrap.rtl.min.css");
    }
