...
(function () {
  ...
  initSimpleBar("header-notification-scroll1");
  initSimpleBar("header-notification-scroll2");
  initSimpleBar("header-notification-scroll3");
  initSimpleBar("header-cart-items-scroll");
  ...
  if (searchInput && typeof autoComplete !== "undefined") {
    new autoComplete({
      ...
      events: {
        input: {
          selection: (event) => {
            searchInput.value = event.detail.selection.value;
          }
        }
      }
    });
