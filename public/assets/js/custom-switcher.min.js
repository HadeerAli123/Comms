...
;
(function(){try{if(!localStorage.getItem('zynixrtl')&&!localStorage.getItem('zynixltr')){localStorage.setItem('zynixrtl',true);if(typeof rtlFn==='function'){rtlFn();}else{document.documentElement.setAttribute('dir','rtl');var s=document.getElementById('style');if(s){var h=s.getAttribute('href')||'';if(h.indexOf('bootstrap.min.css')>-1){s.setAttribute('href',h.replace('bootstrap.min.css','bootstrap.rtl.min.css'));}}}}}catch(e){}})();
